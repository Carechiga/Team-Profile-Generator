//this is the HTML template for the index.html file it needs the employee information, which is handled in the functinos below
...
const EngineerInfoHTML = (engineers) => {
    ...
    <div class="employee-content-line"><b>Github:</b> <a href="https://www.github.com/${engineers[i].github}" target="_blank">${engineers[i].github}</a></div>
